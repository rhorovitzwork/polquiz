questions =  [
    {"id": 0, "question": "Freedom of business is the most practical way a society can prosper.", "effects": {"right": 1}},
    ...
    {"id": 5, "question": "Communism is an ideal but it can never work in practice.", "effects": {"right": 1}},
    ...
    {"id": 8, "question": "Corporations cannot be trusted and need to be regulated by the government.", "effects": {"right": -1}},
    ...
    {"id": 11, "question": "Land should not be a product to be bought and sold.", "effects": {"right": -1}},
    {"id": 12, "question": "All industry and the banks should be run by the government.", "effects": {"right": -1}},
    ...
    {"id": 15, "question": "Sometimes it is right for the government to spy on its citizens to stop extremists and terrorists.", "effects": {"auth": 1}},
    ...
    {"id": 18, "question": "Only the government can fairly and effectively regulate organizations.", "effects": {"auth": 1}},
    ...
    {"id": 25, "question": "Juries should be able to ignore the law if they think it is unjust.", "effects": {"auth": -1}},
    ...
    {"id": 34, "question": "Animals deserve some universal rights.", "effects": {"prog": 1}},
    {"id": 35, "question": "The "rules" about what men and women should like and do are social constructs, not a natural state of affairs.", "effects": {"prog": 1}},
    ...
    {"id": 39, "question": "Transgender people should not be able to adopt children.", "effects": {"prog": -1}},
    ...
    {"id": 43, "question": "People cannot behave morally without religion.", "effects": {"prog": -1}},
    ...
    {"id": 45, "question": "It is bad for a society to have multiple cultures within it. Good societies have only one culture.", "effects": {"prog": -1}}
];
